...
resource "aws_security_group_rule" "mongodb_app_alb" {
...
resource "aws_security_group_rule" "mysql_app_alb" {
    source_security_group_id = module.app_alb.sg_id
  type              = "ingress"
  from_port         = 8080
  to_port           = 8080
...
resource "aws_security_group_rule" "rabbitmq_app_alb" {
    source_security_group_id = module.app_alb.sg_id
  type              = "ingress"
  from_port         = 8080
  to_port           = 8080
...
resource "aws_security_group_rule" "redis_app_alb" {
    source_security_group_id = module.app_alb.sg_id
  type              = "ingress"
  from_port         = 6379
  to_port           = 6379
